...
namespace Listdemo
{
    ...
    public class DemoParser
    {
        ...
        public static SourceDemoParseResult ParseDemo(string file)
        {
            ...
            try
            {
                ...
                using (var br = new BinaryReader(fs))
                {
                    ...
                    result.PTime = ToSingle(br.ReadBytes(4), 0);
                    result.Pticks = ToInt32(br.ReadBytes(4), 0);
                    result.Pframes = ToInt32(br.ReadBytes(4), 0);
                            ...
                            case 0x04:
                                {
                                    ...
                                    if (concmd.Contains("#SAVE#"))
                                    {
                                        ...
                                        {
                                            result.MTicks = tick;
                                            result.Flags.Add(new Flag(tick, tick * TickRate, "#SAVE#"));
                                        }
                                    }
                                    ...
                                    if (concmd == "autosave")
                                    {
                                        ...
                                        if (tick >= 0)
                                        {
                                            result.Flags.Add(new Flag(tick, tick * TickRate, "autosave"));
                                        }
                                    }
            ...
            result.TotalTime = result.TotalTicks * TickRate; // 1 tick = 0.015s
            return result;
            #endregion
        }
    ...
    public class SourceDemoParseResult
    {
        public SourceDemoParseResult()
        {
            ...
            Flags = new List<Flag>();
            Cheetz = new List<string>();
        }

        public int EffectiveTicks => MTicks == 0 ? TotalTicks : MTicks;
        ...
        public int MTicks { get; set; }
        public float PTime { get; set; }
        public int Pframes { get; set; }
        public int Pticks { get; set; }
